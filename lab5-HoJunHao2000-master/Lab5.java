...
class Lab5 {
  ...
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>> getM = 
        new Transformer<>() {
          @Override
          public Maybe<Map<String, String>> transform(Map<String, Map<String, String>> db) {
            return Maybe.of(db.get(module));
          }
        };

    Transformer<Map<String, String>, Maybe<String>> getA = new Transformer<>() {
      @Override
      public Maybe<String> transform(Map<String, String> db) {
        return Maybe.of(db.get(assessment));
      }
    };

    return Maybe.of(map.get(student)).flatMap(getM).flatMap(getA).orElse("No such entry");
  }

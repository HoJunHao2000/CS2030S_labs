...
class BusAPI {
   ...
   * @return A CompletableFuture containing the HTTP resposne body, or an empty string if the 
   *     query fails.
   */
   ...
   *     listing the bus stops that are serviced at this bus.  Return an empty
   ...
   * @return A CompletableFuture containing the string returned by the CS2030 BUS API service
   *     listing the bus services that stopped at this bus stop; an empty 
